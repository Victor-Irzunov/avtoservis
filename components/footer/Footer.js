...
export default function Footer() {
	return (
		<footer className="footer footer-center p-10 bg-base-200 text-base-content rounded relative" id='kontakty'>
			...
			<nav>
				...
				<div className='mt-4'>
					<a href='tel:8029' className='btn btn-neutral text-xl'>
						+375 29 000-00-00
					</a>
				</div>
			</nav>
			...
			<aside className='my-6'>
				<p className=''>
					Юр.адрес: 220000 Минская обл., г. Минск ул. Минская д.100
				</p>
				<p className=''>
					УНП 692000000
				</p>
				<p className=''>
					ЗАО "Альфа-Банк" БИК ALFABY2X р/с BY92ALFA30122D60990000000000
				</p>
			</aside>
			...
			<div className='absolute bottom-0 left-0 right-0 w-full'>
				<Image src='/bg/bgBlur.png' alt='фоновое изображение' width={1536} height={296} className="w-full" />
			</div>
		</footer >
	)
}